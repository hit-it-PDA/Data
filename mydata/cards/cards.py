...
# 은행 계좌 엑셀 파일 읽기
bank_accounts_df = pd.read_excel('../../db/은행_계좌.xlsx')
...
df = pd.DataFrame(data, columns=[
    'card_no', 'company_name', 'name', 'card_type', 'created_at', 'expired_at', 'user_id', 'accounts_no'
])

# 엑셀 파일로 저장
df.to_excel('../../db/카드.xlsx', index=False)
